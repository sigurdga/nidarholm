...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteProfile.admingroup'
        db.add_column('organization_siteprofile', 'admingroup', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='administers_sites', to=orm['auth.Group']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteProfile.admingroup'
        db.delete_column('organization_siteprofile', 'admingroup_id')
    ...
    models = {
        ...
        'organization.siteprofile': {
            ...
            'admingroup': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'administers_sites'", 'to': "orm['auth.Group']"}),
