...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteProfile.updated'
        db.alter_column('organization_siteprofile', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'SiteProfile.created'
        db.alter_column('organization_siteprofile', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SiteProfile.updated'
        db.alter_column('organization_siteprofile', 'updated', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'SiteProfile.created'
        db.alter_column('organization_siteprofile', 'created', self.gf('django.db.models.fields.DateTimeField')())
