...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.personal_website'
        db.add_column('accounts_userprofile', 'personal_website', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.employer_website'
        db.add_column('accounts_userprofile', 'employer_website', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.created'
        db.add_column('accounts_userprofile', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.updated'
        db.add_column('accounts_userprofile', 'updated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.personal_website'
        db.delete_column('accounts_userprofile', 'personal_website')

        # Deleting field 'UserProfile.employer_website'
        db.delete_column('accounts_userprofile', 'employer_website')

        # Deleting field 'UserProfile.created'
        db.delete_column('accounts_userprofile', 'created')

        # Deleting field 'UserProfile.updated'
        db.delete_column('accounts_userprofile', 'updated')
