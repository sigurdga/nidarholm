...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_userprofile', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.postcode'
        db.alter_column('accounts_userprofile', 'postcode', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True))
