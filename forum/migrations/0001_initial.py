...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Debate'
        db.create_table('forum_debate', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['forum.Debate'])),
        ...
        db.send_create_signal('forum', ['Debate'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Debate'
        db.delete_table('forum_debate')
