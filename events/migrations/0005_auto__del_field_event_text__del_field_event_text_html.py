...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.text_html'
        db.delete_column('events_event', 'text_html')


    def backwards(self, orm):
        
        # Adding field 'Event.text'
        db.add_column('events_event', 'text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Event.text_html'
        db.add_column('events_event', 'text_html', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
