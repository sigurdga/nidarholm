...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlatPage.admingroup'
        db.add_column('pages_flatpage', 'admingroup', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='administers_pages', to=orm['auth.Group']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlatPage.admingroup'
        db.delete_column('pages_flatpage', 'admingroup_id')
